...
4. 컨트롤러에서 외부파일을 읽어서 프로그램에 적용
	...
	4-5) 읽은 내용을 Model에 저장하거나 비즈니스 로직에
		직접 사용함.
 -->
...
3. 요청명에 따른 컨트롤러 생성
	-업로드 폼, 업로드 처리 등에 진행하고
	-파일명 변경을 위해 UUID클래스를 통한 유니크한 문자열 생성
4. 파일이외의 나머지 폼값과 확인하는 페이지 작성
