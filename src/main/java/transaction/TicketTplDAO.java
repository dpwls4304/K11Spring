...
public class TicketTplDAO {
	...
	//JDBDTemplate를 사용하기 위한 멤버변수 세터설정
	JdbcTemplate template;
	public void setTemplate(JdbcTemplate template) {
		this.template = template;
	}
	
	//트랜잭션 템플릿을 사용하기 위한 멤버변수 및 세터설정
	...
	public boolean buyTicket(final TicketDTO dto) {
		System.out.println("buyTiecket() 메소드 호출");
		...
		try {
			...
			//별도의 commit() 혹은 rollback이 필요없다.
			System.out.println("카드결제와 티켓구매 모두 정상 처리되었습니다.");
